            ...
            for s in invites:
                if s[0] == i.code:
                    if int(i.uses) > s[1]:
                        ...
                        eme = discord.Embed(description="A rejoint le serveur !", color=0x03d692, title=" ")
                        ...
                        eme.add_field(name="Utilisateur invité !",
                                      value="Inviteur : " + i.inviter.mention + " | Utilisations : " + str(
                                          i.uses), inline=False)
